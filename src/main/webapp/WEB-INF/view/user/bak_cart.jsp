                ...
                <aside class="col-lg-8 col-lg-offset-0 col-md-7 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
                    ...
                    <c:forEach var="item" items="${sessionScope.cart}">
                        ...
                        <div class="row order__row u-margin-LR-none">
                            ...
                            <div class="col-lg-3 col-lg-offset-0 col-md-3 col-md-offset-0 col-sm-12 col-xs-offset-0 col-xs-12">
                                <div class="order__cell">
                                    <p class="order__cell--box-info">
                                        <input value="${item.product.salePrice}" class="js-item-price" type="number" readonly>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-lg-offset-0 col-md-2 col-md-offset-0 col-sm-4 col-sm-offset-4 col-xs-offset-4 col-xs-4">
                                <div class="order__cell">
                                    <%--<input class="js-item-quantity" type="number" min="1" max="999999">--%>
                                    <input name="quantity" id="quantity" value="" class="js-item-quantity" type="number" min="1" max="999999">
                                </div>
                            </div>
                        ...
                        <form:form action="/cart/buy" method="post">
                            ...
                            <div class="row total__row">
                                <div class="col-md-6 total__cell">
                                    ...
                                    <p class="total__cell--sub" id="js-total"></p>
...
<script src="${pageContext.request.contextPath}/assets/js/accounting.min.js"></script>
<script>
    $(document).ready(function(){
        // UPDATE QUANTITY and TOTAL PRICE
        update_amounts();
        $(".js-item-quantity").bind('input',function () {
            update_amounts();
        });
        function update_amounts() {
            var sum = 0.0;
            $(".order .order__row").each(function () {
                var qty = $(this)
            ...
            document.getElementById("js-total").innerHTML = accounting.formatNumber(sum);
